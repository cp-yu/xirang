...
describe('Integration: Bootstrap Workflow', () => {
  ...
  describe('Bootstrap: Create initial Xirang structure', () => {
    it('should create minimal valid project.xirang.yaml', async () => {
    ...
    it('should create Xirang with discovered domains', async () => {
      const bundle = mkBundle({
        domains: [
    ...
    it('should create Xirang with discovered capabilities', async () => {
      const caps = [
