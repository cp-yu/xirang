...
describe('opsx-build workflow', () => {
  ...
  it('authors and reviews one Architecture plus Specs Candidate', () => {
    ...
    expect(skill.instructions).toContain('.opsx/candidate/architecture/');
    expect(skill.instructions).toContain('.opsx/candidate/specs/');
    expect(skill.instructions).toContain('opsx candidate validate');
    expect(skill.instructions).toContain('reviewDigest');
    expect(skill.instructions).toContain('opsx candidate promote --digest');
