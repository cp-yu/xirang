# cli-check-delta Specification

## Purpose
This specification records behavior introduced by change add-check-delta-command. Replace this Purpose with the formal capability intent before archive.
## Requirements
