...
2. **Where should exploration files live?**
   - `opsx/explorations/<name>.md`?
   - `.opsx/changes/<change>/explorations/`?
   - `.opsx-workspace/initiatives/<initiative>/explorations/` for coordinated work?
   - Somewhere else?
...
- Saves to `opsx/explorations/<name>.md`
...
- `.opsx/changes/simplify-skill-installation/` - current change updating core workflows
