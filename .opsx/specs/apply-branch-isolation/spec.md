...
- `.opsx/references/opsx-apply-step-3-branch-isolation.md`
- `.opsx/references/opsx-apply-step-3-worktree-isolation.md`
- `.opsx/references/opsx-apply-step-3-current-branch.md`
