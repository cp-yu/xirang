...
### Requirement: 以实体粒度作用
Entry SHALL 作用于 Element Declaration、Contract Requirement、Relationship、Element Kind、Relationship Kind 或 Authored View；同一 entity type 与 identity 在一个 Delta 中 SHALL NOT 存在冲突操作。
