...
- **WHEN** `xirang-verify/SKILL.md` 的 claude 和 codex 变体为 604 行，default 变体为 580 行
- **THEN** 错误信息 MUST 显示为两行：
  - `• xirang-verify/SKILL.md (claude, codex): 604 lines (+404, limit 200)`
  - `• xirang-verify/SKILL.md (default): 580 lines (+380, limit 200)`
