---
element: validation.frontmatter
---
...
#### Scenario: [REMOVED] 多个 capabilities

- **WHEN** spec 内容的 frontmatter 包含多个 cap ID
- **THEN** 函数 SHALL 返回所有声明的 cap ID，保持声明顺序

#### Scenario: [REMOVED] frontmatter 无 capabilities 字段
