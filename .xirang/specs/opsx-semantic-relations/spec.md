---
element: cap.xirang.semantic-relations
---
...
OPSX Semantic Model graph SHALL 使用 `.xirang/architecture/**/*.c4` 的 versioned OPSX LikeC4 profile，并与 `.xirang/specs/**/*.md` contract modules 共同形成 formal model。系统 MUST NOT 读取 legacy YAML graph 作为新版 model 的 runtime fallback。
