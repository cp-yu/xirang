...
- **AND** 测试 MUST NOT 将两个文件相加后报告 `xirang-optimizer` 超标
...
- **AND** `xirang-apply-change` 的 Phase 2 优化协议 MUST 物化为 `.xirang/references/xirang-apply-phase2-optimization.md`
- **AND** `xirang-archive-change` 的 commit message 格式说明 MUST 物化为 `.xirang/references/xirang-boundary-commit-message.md`、`.xirang/references/xirang-archive-commit-message.md` 与 `.xirang/references/xirang-merge-summary-message.md`
