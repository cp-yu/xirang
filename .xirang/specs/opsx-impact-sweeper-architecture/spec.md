...
Sweeper SHALL 使用 `xirang arch query` 导航 OPSX Semantic Model，并 SHALL 将 stable elements、abstraction/refinement hierarchy、Element Contracts 与 semantic relationships 作为 impact context。
