---
element: cap.ai.snack-skill-generation
---
...
- **WHEN** 运行 `xirang update` 或 `xirang init`
- **THEN** 生成 `.claude/skills/opsx-snack/SKILL.md`，包含：
  ...
  6. Spec 覆盖扫描步骤（`xirang list --specs --json`）
...
- **WHEN** tests inspect generated `opsx-snack/SKILL.md`
