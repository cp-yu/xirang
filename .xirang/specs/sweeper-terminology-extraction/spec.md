...
- **AND** sweeper 通过 `xirang list --specs --json` 确定与候选 capabilities 关联的 Specs
...
- **WHEN** spec 文件路径为 `.xirang/specs/apply-change-workflow/spec.md`
...
- **WHEN** 生成 `opsx-impact-sweeper` skill 文件
