...
Apply skill SHALL 指导 Agent 从 Project Root 开始读取 Target OPSX Semantic Model，并使用 `xirang arch query` 按 stable `elementId` 导航 abstraction/refinement hierarchy、owned Specs 与 semantic relationships。
