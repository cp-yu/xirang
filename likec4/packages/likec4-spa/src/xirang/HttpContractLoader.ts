import type { XirangContractContent, XirangRuntimeManifest, XirangContractLoader } from '@likec4/diagram'
...
export class HttpContractLoader implements XirangContractLoader {
  constructor(
