# OPSX Property-Based Test Guarantees

Current property-based tests exercise OPSX parsers, path handling, validation invariants, and deterministic artifact generation. The active architecture contract is LikeC4 under `.opsx/architecture/`; no property test should treat a parallel YAML graph as durable source.
...
- only project-relative `.opsx/specs/**/*.md` paths are accepted
